...
export const metadata: Metadata = {
  title: "ITSchool - Master Programming & Tech Skills Online",
  description: "Learn programming, web development, data science & mobile development with expert instructors. 95% job placement rate. Start your tech career today.",
  keywords: "programming courses, web development, data science, mobile development, IT education, online learning, tech careers",
  metadataBase: new URL("https://itschool.com"),
  alternates: {
    canonical: "https://itschool.com"
  },
  openGraph: {
    title: "ITSchool - Master Programming & Tech Skills Online",
    description: "Learn programming, web development, data science & mobile development with expert instructors. 95% job placement rate.",
    siteName: "ITSchool",
    type: "website"
  },
  twitter: {
    ...
    title: "ITSchool - Master Programming & Tech Skills Online",
    description: "Learn programming, web development, data science & mobile development with expert instructors."
  },
  robots: {
    index: true,
    follow: true
